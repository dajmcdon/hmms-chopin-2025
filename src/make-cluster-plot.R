...
ggplot(m2, aes(Var1, Var2, fill = value)) +
  ...
  coord_equal() +
  xlab("") + ylab("") +
  geom_hline(yintercept = sply, color = "#f3f3f3", size = .2) +
  geom_vline(xintercept = splx, color = "#f3f3f3", size = .2) +
...
ggsave("gfx/other-rem-alt1-1.png", dpi = 300, bg = "transparent", width=8, height=5)
...
ggsave("gfx/other-rem-alt2-1.png", dpi = 300, bg = "transparent", width=5, height=1)
